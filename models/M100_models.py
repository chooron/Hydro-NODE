...
class M100_NN(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, hidden_units=32):
        super().__init__()
...
class M100_ODEFunc(nn.Module):
    def __init__(self, net, f, Smax, Qmax, Df, Tmax, Tmin):
        super().__init__()
        self.net = net
        self.f = f
        self.Smax = Smax
...
class M100(BaseLearner):
    def __init__(self, model: nn.Module, loss_metric=MeanSquaredError(), eval_metric_list=None):
